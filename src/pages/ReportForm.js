        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              <button type="submit" disabled={loading || compressingImages || compressingVideo} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                {loading || compressingImages || compressingVideo ? (
                  <span className="flex items-center gap-2">
                    ...
                    {(compressingImages || compressingVideo) 
                      ? (isRtl ? 'جاري ضغط الوسائط...' : 'Compressing media...') 
