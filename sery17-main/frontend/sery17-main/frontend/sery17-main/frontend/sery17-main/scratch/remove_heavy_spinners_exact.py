...
def process_file(filepath):
    ...
    content = content.replace(exact_heavy_spinner, light_spinner)
    content = content.replace(exact_heavy_spinner_2, light_spinner)
    content = content.replace(exact_heavy_spinner_3, light_spinner)
